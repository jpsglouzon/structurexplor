  ...
  fluidRow(column(12,
    ...
    tabItem(tabName = "about",
            ...
            tags$h3(align="center",
                    HTML('StructureXpl<i class="fa fa-compass"></i>R version 0.1'),br(),
                    "is maintained by Jean-Pierre Glouzon",br(),
                    HTML(' <a href="http://info.usherbrooke.ca/Prospectus" target="_blank">Prospectus Lab.</a> ')," & ",
                    HTML(' <a href="http://jpperreaultlab.recherche.usherbrooke.ca/" target="_blank">Jean-Pierre Perreault Lab.</a> '),br(),
                    HTML(' <a href="http://www.usherbrooke.ca/" target="_blank">Université de Sherbrooke</a> '),br(),
                    "GPL licence, 2016"
                    )
